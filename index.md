...
I am an astronomer for the European Space Agency (ESA) at the Space Telescope Science Institute, Baltimore, Maryland, USA. I work on combining astrometric and radial velocity data to find promising candidates to directly image, and spectrally and atmospherically characterize any detections. I work on the Hubble Space Telescope STIS team, as well as the James Webb Space Telescope MIRI team, and I am also a member of the JWST telescope scientist team, working as a project-level member on coronagraphic imaging.
...
[Email Me](mailto:erickman@stsci.edu)

[LinkedIN](https://www.linkedin.com/in/emily-rickman/)

## Full list of NASA/ADS publications:

[NASA/ADS Library](https://ui.adsabs.harvard.edu/public-libraries/aMcI8qLxTg6k-YuwhKtdyQ)
